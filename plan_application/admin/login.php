...
<head>
    ...
    <title>LOGIN | <?php echo $_SESSION['system_info']['company_name'] ?></title>
...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light" id="title"><?php echo $_SESSION['system_info']['company_name'] ?></h1>
